...
public class MyCardsFilterBottomSheet extends BottomSheetDialogFragment {
    ...
    public static MyCardsFilterBottomSheet newInstance(CardFilterState state) {
        ...
        args.putString("closedFilter", state.closedFilter.name());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (args != null) {
            ...
            currentState.closedFilter = CardFilterState.ClosedFilter.valueOf(
                    args.getString("closedFilter", "OPEN_ONLY"));
        }
        ...
        binding.btnApplyFilter.setOnClickListener(v -> {
            ...
            result.putString("closedFilter", currentState.closedFilter.name());
    ...
    private void applyStateToUi() {
        ...
        // Closed
        switch (currentState.closedFilter) {
            case ALL: binding.chipClosedAll.setChecked(true); break;
            case CLOSED_ONLY: binding.chipClosedOnly.setChecked(true); break;
            default: binding.chipClosedOpenOnly.setChecked(true); break;
        }
    }
    ...
    private void readStateFromUi() {
        ...
        // Closed
        int closedId = binding.chipGroupClosed.getCheckedChipId();
        if (closedId == R.id.chip_closed_all) currentState.closedFilter = CardFilterState.ClosedFilter.ALL;
        else if (closedId == R.id.chip_closed_only) currentState.closedFilter = CardFilterState.ClosedFilter.CLOSED_ONLY;
        else currentState.closedFilter = CardFilterState.ClosedFilter.OPEN_ONLY;
    }
